    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="form-control">
        ...
        <div className="relative">
          ...
          <div className="z-10 absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none"></div>
          <input
          ...
          />
          <div className="z-10 absolute inset-y-0 right-0 pr-3 flex items-center">
            <button
              type="button"
